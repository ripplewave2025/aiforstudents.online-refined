                ...
                {!podcastOpen ? (
                  ...
                  >
                    ...
                    <div className="relative shrink-0 w-11 h-11 rounded-xl overflow-hidden">
                      <img src="/classroom.jpg" alt="episode" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                  ...
                  <motion.div
                    ...
                    className="rounded-2xl overflow-hidden shadow-float border border-white/20 bg-black"
                  >
                    <iframe
